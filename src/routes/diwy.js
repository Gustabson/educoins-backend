...
router.get('/students', auth, roles('admin', 'maestra'), async (req, res) => {
  try {
...
router.post('/observations', auth, roles('admin', 'maestra'), async (req, res) => {
  try {
...
router.get('/observations/:studentId', auth, roles('admin', 'maestra'), async (req, res) => {
  try {
    const { rows } = await db.query(`
...
router.delete('/observations/:id', auth, roles('admin', 'maestra'), async (req, res) => {
  try {
...
router.post('/generate/:studentId', auth, roles('admin', 'maestra'), async (req, res) => {
  try {
...
router.get('/reports/:studentId', auth, roles('admin', 'maestra'), async (req, res) => {
  try {
    const { rows } = await db.query(`
...
router.patch('/reports/:id/review', auth, roles('admin', 'maestra'), async (req, res) => {
  try {
...
router.patch('/reports/:id/approve', auth, roles('admin', 'maestra'), async (req, res) => {
  try {
    const { rows } = await db.query(`
      UPDATE diwy_reports
      SET estado = 'aprobado',
...
router.get('/teacher/classrooms', auth, roles('admin', 'maestra'), async (req, res) => {
  try {
    const { rows } = await db.query(`
...
router.get('/teacher/messages', auth, roles('admin', 'maestra'), async (req, res) => {
  try {
...
router.patch('/teacher/messages/:id/reply', auth, roles('admin', 'maestra'), async (req, res) => {
  try {
...
router.post('/teacher/preview', auth, roles('admin', 'maestra'), async (req, res) => {
  try {
